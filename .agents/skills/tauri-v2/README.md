...
This is a plain Agent Skills directory:

- pi project install: `.agents/skills/tauri-v2/`
- opencode project install: `.opencode/skills/tauri-v2/`

The files are intentionally self-contained Markdown. Resolve links relative to the skill directory that was loaded.
...
Use this skill for Tauri-specific backend, IPC, capability, mobile, and distribution work. Use the existing Rust, Vue, or debugging skills only when the task is primarily about those domains rather than Tauri itself.
