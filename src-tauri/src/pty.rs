...
fn shell_command(shell: TerminalShell) -> CommandBuilder {
    #[cfg(windows)]
    {
        match shell {
            TerminalShell::Cmd => CommandBuilder::new("cmd.exe"),
            TerminalShell::PowerShell => CommandBuilder::new("powershell.exe"),
            TerminalShell::Wsl => CommandBuilder::new("wsl.exe"),
        }
    }
    #[cfg(not(windows))]
    {
